...
function setup() {
  ...
  clearBTN = createButton("Clear Trail");
  clearBTN.position(20, 140);
  clearBTN.mousePressed(clearTrail);
...
function mousePressed() {
  ...
  if (mouseX < 20 || mouseX > 120 || mouseY < 20 || mouseY > 160) {
...
function clearTrail() {
  movers = []; // Vider la liste des projectiles*
}
